  ...
  return (
    <main className="min-h-screen bg-[#f5f8fc] pb-20 text-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        {/* HERO */}
        <section className="mt-5 rounded-2xl bg-gradient-to-r
          from-[#2450a5] to-[#159b91]
          ...
          <div className="flex flex-col gap-5 sm:flex-row
            ...
            <div>
              <span className="inline-flex rounded-full
                bg-white/15 px-3 py-1 text-[10px] font-semibold
                tracking-wide ring-1 ring-white/20">
                ● Centre active today
              </span>

              <h2 className="mt-3 max-w-md text-2xl font-extrabold
              ...
              <p className="mt-2 max-w-lg text-sm
                leading-5 text-white/75">
                Monitor development, identify risks early and
                keep today's screenings on track.
              </p>
            </div>

            <button
              onClick={() => navigate("register")}
              className="w-full rounded-xl bg-white px-5 py-3
                text-sm font-bold text-[#2450a5]
        ...
        <section className="mt-5 grid gap-4 lg:grid-cols-[1.4fr_0.8fr]">
          ...
          <div className="overflow-hidden rounded-2xl bg-white shadow-sm
            ...
            <div className="border-b border-slate-100
              bg-gradient-to-r from-[#fffaff] to-white
              px-5 py-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="text-xs font-bold text-[#2450a5]">
                  View all
                </button>
              ...
              {followUps.map((child, index) => (
                ...
                >
                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="grid h-9 w-9 shrink-0
                      place-items-center rounded-full
                      bg-[#eaf6f7] text-[10px] font-bold
                      text-[#159b91]">
                      {child.name
                        .split(" ")
                        .map((word) => word[0])
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="grid h-9 w-9 place-items-center
                rounded-full bg-[#e9f8f5] text-sm text-[#159b91]">
                ✓
              </div>
            ...
            <div className="mt-7 flex items-end justify-between">
              ...
              <p className="text-sm font-bold text-[#159b91]">
                60%
              </p>
            ...
            <div className="mt-4 h-2 overflow-hidden rounded-full
              ...
              <div className="h-full w-[60%] rounded-full
                bg-gradient-to-r from-[#2450a5] to-[#159b91]" />
            </div>
            ...
            <button
              ...
              className="mt-5 w-full rounded-xl border
                border-[#d8e5f5] bg-white px-4 py-3
                text-xs font-bold text-[#2450a5]
                transition hover:bg-[#f5f8fc]"
            >
              Start New Screening →
            </button>
  ...
  return (
    ...
    >
      ...
      <span className="grid h-9 w-9 shrink-0 place-items-center
        rounded-lg bg-blue-50 text-sm font-bold text-[#2450a5]">
        {icon}
      </span>
